...
router.post('/addCarImages', requireAuthUser, uploadfile, carController.addCar);
router.get('/getAllCars', carController.getAllCars);
router.get('/getCarById/:id', carController.getCarById);
router.put('/UpdateCarById/:carId', requireAuthUser, uploadfile, carController.UpdateCarById);
